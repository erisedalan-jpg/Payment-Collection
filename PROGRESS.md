...
- 当前版本：**V1.20.0**
- 最近更新：2026-06-24（新增「重点跟进」导航分区 + /projects/key 重点项目进展页；进展持久化/编辑/归档/导出）
- 上一版本：V1.19.2（2026-06-24，侧边栏分区可折叠：默认仅展开当前页分区，状态持久化 ui store）
- 更上版本：V1.19.1（2026-06-24，售前服务类项目的 TOP1000/象限 改按原项目最终客户判定；仅后端，需点「更新数据」重跑生效）
- 上上版本：V1.19.0（2026-06-24，新增 TOP1000.xlsx 客户清单数据源：top1000/quadrant 派生到项目主域；/data 上传、/projects 两列、/project/:id 详情、/insight·/board·/risk 三维度）
- 维护语言：简体中文

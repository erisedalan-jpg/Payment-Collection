...
- 当前版本：**V1.8.0**
- 最近更新：2026-06-18（子项目2 在建/已关闭项目清单：已关闭全量摄取交付三部 closedProjects(轻量 PMIS 已关闭三表 + closeInfo)、meta.totalClosed=len、前端 /projects 在建 + /projects/closed 已关闭两路由 + /closed-project/:id 精简详情、导航在建项目/已关闭项目）
- 上一版本：V1.7.1（2026-06-18，详情页 /project/{id} 头部 pd-meta 增「合同编号」展示，与项目编号同级、位于项目名称与卡片之间，取自 project.合同编号，消费子项目1 M-2 遗留字段；合并 62687ba）
...
- [x] **子项目2 在建/已关闭项目清单（2026-06-18，V1.8.0，feat/closed-projects-list，合并SHA待回填）**：已关闭全量摄取交付三部 closedProjects(轻量 PMIS 已关闭三表 + closeInfo)、meta.totalClosed=len、前端 /projects 在建 + /projects/closed 已关闭两路由 + /closed-project/:id 精简详情、导航在建项目/已关闭项目。

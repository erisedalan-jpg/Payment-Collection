...
- 当前版本：**V1.3.0**
- 最近更新：2026-06-15（2B 回款看板重建：/panalysis 整页 PMIS 化——5 tab 全部换骨为 projects[].paymentPmis + paymentNodes 派生视图，共享维度选择器（部门/阶段/金额档/进度态），撤销数据质检 tab，删 /panalysis 独占旧件）
- 维护语言：简体中文

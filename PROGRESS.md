...
- 最近更新：2026-07-01（V2.5.9：下钻返回保持视图状态——选择性 keep-alive + beforeResolve 返回判定 + `.app-main` 滚动记忆;下钻返回完整恢复、菜单进入重置、换号清空;SDD 6 任务 + 冒烟 10/10;特性分支 feat/v2_5_9-drilldown-return 待合并+打包;附带修 cellFormat.excelDate 既有时区 off-by-one）

...
- 最近更新：2026-06-30（V2.5.3：侧栏六分区子项版式统一[nav-item→nav-sub,与项目分析对齐] + 首页「成本超支」card 按 projectId 去重[整体∩交付不重复计,107→87]）

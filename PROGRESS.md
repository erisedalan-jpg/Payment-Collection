...
- 最近更新：2026-07-02（V2.6.0：回款域重构 P1——/payment 总览重做[项目数改整体638+81无阶段副字/删两卡/回款数据表改名增大/无阶段清单]、/payment/projects 表格化+级别列-来源列+抽屉900px+无阶段态、/payment/nodes 删维度+经理·L4列、删 plan/risk/ledger 三页；新增统一标签筛选 tagFilter[含无标签]；SDD 9 任务 + 冒烟 27/27；待合 master）

...
- 最近更新：2026-07-02（V2.6.1：回款域重构 P2——新页 /payment/key 回款重点跟进[仿 temp,归档留存不清空]+新 pageKey payment-key+纳入 keep-alive;并做 4 项 P1 修复[标签筛选缩窄/项目数整卡可点/无阶段清单分页];SDD 8 任务+冒烟功能全过;待合 master,本轮不出包到 P4 统一打）

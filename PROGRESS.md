...
- V1.10.2 纯展示标签改名：DashMetrics 延期→延期项目数、回款节点→回款节点数；BoardView 排序选项 延期数→延期节点数；LedgerView 统计卡 延期→延期项目数；InsightView RANK_COLS + projectPivot INSIGHT_METRICS 延期项目→延期项目数。合并 SHA: <finishing 回填>

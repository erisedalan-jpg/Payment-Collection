...
- 最近更新：2026-06-30（V2.5.2：全局 Apple 风微交互/质感打磨——KPI 卡上浮、按钮回弹、同步点脉冲、分段控件抬起 chip、侧栏选中条、弹窗遮罩模糊；新增 `--lift/--focus-ring/--glass-backdrop` 等令牌 + `.u-lift/.u-press/.u-pulse` 工具类）

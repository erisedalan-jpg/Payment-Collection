...
- 当前版本：**V1.2.0**
- 最近更新：2026-06-15（2A 数据底座：项目行 PMIS 核心回款模型 paymentPmis+paymentNodes，节点比例解析里程碑关联回款阶段，售前合同走原项目/流水本项目优先）
- 维护语言：简体中文

...
- 最近更新：2026-07-01（V2.5.5：图表 hover 卡顿修复——ChartBox 全站 tooltip 改 richText 根除 HTML tooltip getSize 强制回流；6x 降速实测柱状图 hover 掉帧降 79–91%。纯前端一处，已提交 master `45ed6bd`+**已生产上线 2026-07-01**，在线基线 V2.5.3→V2.5.5 累积含 V2.5.4）

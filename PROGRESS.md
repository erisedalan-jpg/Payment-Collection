...
- 最近更新：2026-07-02（V2.6.4：/insight/board 回款完成率区间口径缺陷修复——看板下钻/分组完成率原为「区间内流水÷全额合同」+默认区间本年度→2025 年回款项目虚显 0%（约 38%）；修为完成率恒全时（actualAll=Σ全时流水），计划/延期仍随区间。TDD+真机冒烟 QAGD-XX-REDACTED 现显 70%。同类隐患 paymentPmis.ts[/payment 系列]未修，待用户决定）

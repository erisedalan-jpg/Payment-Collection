  ...
  ds.data = {
    ...
    projects: [
      { projectId: 'P1', projectName: '甲项目', orgL4: '北京', projectManager: '张三',
        payment: { relatedNodeCount: 3, expectedTotal: 1500000, nodeActualTotal: 600000, remainingTotal: 900000, paymentRatio: 0.3, delayedCount: 2 },
      ...
      { projectId: 'P2', projectName: '乙项目', orgL4: '上海', projectManager: '李四',
        payment: { relatedNodeCount: 1, expectedTotal: 300000, nodeActualTotal: 300000, remainingTotal: 0, paymentRatio: 1, delayedCount: 0 },

...
export interface PaymentKeyArchiveResp { success: boolean; archives: Archive[] }
...
export const paymentKeyFollowupApi = {
  ...
  update: (projectId: string, field: 'followAction' | 'revConclusion' | 'nextRevDate', content: string) =>
